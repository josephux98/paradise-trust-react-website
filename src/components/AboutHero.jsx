export default function AboutHero() {
  return (
    <>
      <section style={S.section} className="about-hero-animated-bg">
        ...
        <div style={S.container}>
          <div style={S.contentWrapper}>
            ...
            <h1 style={S.heading}>About Us</h1>
            
            <p style={S.paragraph}>
              Paradise Family &amp; Social Welfare Trust is dedicated to serving the elderly, 
              the poor, and vulnerable communities with compassion and dignity. Since 2015, 
              we have worked to provide shelter, healthcare support, education, and community 
              programs that uplift lives and restore hope. Our mission is to build a caring 
              society where every individual is valued, supported, and empowered to live with dignity.
            </p>
          </div>
        </div>
      </section>
